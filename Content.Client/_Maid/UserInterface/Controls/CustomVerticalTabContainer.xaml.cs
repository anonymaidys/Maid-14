...
namespace Content.Client._Maid.UserInterface.Controls;

[GenerateTypedNameReferences]
public sealed partial class CustomVerticalTabContainer : BoxContainer
{
    ...
    public CustomVerticalTabContainer()
    {
